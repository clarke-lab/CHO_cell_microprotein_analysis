...
samples = { K : pd.read_table("quantitation/gene/count_output/%s.txt" % K,sep="\t",header=0,comment="#",index_col=None) for K in sample_names }
...
# save
combined_df.to_csv("quantitation/gene/count_output/combined_counts.txt",sep="\t",header=True,index=False,
