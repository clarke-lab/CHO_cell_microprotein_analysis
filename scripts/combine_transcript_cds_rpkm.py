...
samples = { K : pd.read_table("quantitation/transcript/new/%s.txt" % K,sep="\t",header=0,comment="#",index_col=None) for K in sample_names }
...
# save
combined_df.to_csv("quantitation/transcript/orfrater_transcript_counts_new.txt",sep="\t",header=True,index=False,
