...
This note book generates the figures for section 2.1 of the manuscript. 
...
ggsave(plot = read_lengths_hist_plot, filename = paste(results_dir, "Figure_1D.png", sep = ""), width = 5, height = 5, device = "png", dpi = 700)
```
## Phasing
```{r include=FALSE}
