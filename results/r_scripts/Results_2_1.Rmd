...
# RPF selected reads
```{r}
read_dir <- "cat ../ribosome_footprint_profiling/data/"
...
rnaseq_dist_command <- "cat ../ribosome_footprint_profiling/data/rnaseq_se/mapped/merged/rnaseq_se.fastq | awk '{if(NR%4==2) print length($1)}' | sort -n | uniq -c > read_length.txt"
