...
ggsave(filename = paste(results_dir,"Figure_3D.png", sep=""), width = 6, height =3, device = "png", dpi = 700)
```
### Rad51d ouORF
```{r}
...
ggsave(filename = paste(results_dir,"Figure_3E.png", sep=""), width = 6, height = 3, device = "png", dpi = 700)
```
...
ggsave(filename = paste(results_dir,"Figure_3F.png", sep=""), width = 6, height = 3, device = "png", dpi = 700)
```