...
# old way - could be removed
  # awk -F',' '$12 == "new" { print $0 }' orfrater_analysis/rate_regression.ncbi.csv | 
  # awk -F',' '$27 >= 0.6 { print $0 }' | \
  # awk -F',' '$12 >=5 { print $0 }' | \
  # awk -F',' '{print $1}' > diff_translation_analysis/selected_novel_orfs.txt
